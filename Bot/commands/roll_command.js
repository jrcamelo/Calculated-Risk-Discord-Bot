...
module.exports = class BaseRollCommand extends BaseCommand {
  ...
  async saveRollStats() {
    ...
    new SaveRollOnPlayerStatsTask(this.serverId, this.message, this.player.stats(), this.roll.stats(), !this.player.rolled).addToQueue()
  ...
  async saveMultipleRollStats() {
    ...
    new SaveMultipleRollsOnPlayerStatsTask(this.serverId, this.message, this.player.stats(), stats, !this.player.rolled).addToQueue()
